...
public class MergeBinaryTree {
    ...
    public static void main(String[] args) {
        ...
        TreeNode res = mergeBinaryTree.mergeTrees(t1, t2);
    ...
    public TreeNode mergeTrees(TreeNode t1, TreeNode t2) {
        ...
        newNode.left = mergeTrees(t1 == null ? t1 : t1.left, t2 == null ? t2 : t2.left);
        newNode.right = mergeTrees(t1 == null ? t1 : t1.right, t2 == null ? t2 : t2.right);
        return newNode;
    }
